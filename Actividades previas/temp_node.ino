...
#define INFLUXDB_URL "http://10.48.106.169:8086"                                                                  //InfluxDB v2 server url, e.g. https://eu-central-1-1.aws.cloud2.influxdata.com (Use: InfluxDB UI -> Load Data -> Client Libraries)
...
void loop()                                                          //Loop function
{
  ...
  Serial.println("Temp: ");                                            //Display readings on serial monitor
  Serial.println(temp);
